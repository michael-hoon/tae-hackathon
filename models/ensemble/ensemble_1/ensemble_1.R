setwd("C:\\SUTD\\40.016 TAE - The Analytics Edge\\000 - COMPETITION\\models\\ensemble\\ensemble_1")
# ==================================================================================
#                               THE GRAND ENSEMBLE
# ==================================================================================
...
predictions <- soft_voting(test_ensemble_XGB, test_ensemble_MNL, test_ensemble_RF, 
                           weights=c(0.5, 0.3, 0.2))
predictions
logloss <- compute_logloss(predictions, test_ensemble_choice)
logloss
accuracy <- compute_accuracy(predictions, test_ensemble_choice)
accuracy
